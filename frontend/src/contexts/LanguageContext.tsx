...
const translations = {
  en: {
    ...
    'hero.quote': 'Empowering citizens with AI-driven justice. Report instantly, safely, and securely using merely your voice.\n A completely seamless portal revolutionizing transparency between law enforcement and the public.',
  ...
  te: {
    'hero.title': 'ఏఐ ఆధారిత ఎఫ్.ఐ.ఆర్ దాఖలు వ్యవస్థ',
    'hero.quote': 'ఆలస్యమైన న్యాయం అన్యాయం.\nఏఐ సహాయంతో మీ ఫిర్యాదును తక్షణమే దాఖలు చేయండి.',
    'hero.btn': 'ఇప్పుడే ఫిర్యాదు చేయండి',
    'banner.heading': 'నిజ-సమయ నవీకరణలు',
    'banner.text': '🔔 24/7 ఏఐ మద్దతు • తక్షణ దాఖలు • సురక్షితం & గోప్యం • బహుభాషా మద్దతు • చట్టపరమైన ఖచ్చితత్వం హామీ',
    'card.citizen.title': 'పౌరులకు',
    'card.citizen.desc': 'మీ భాషలో ఏఐ వాయిస్ సహాయంతో మీ ఎఫ్.ఐ.ఆర్ ని త్వరగా మరియు సులభంగా దాఖలు చేయండి.',
    'card.citizen.btn': 'ఎఫ్.ఐ.ఆర్ దాఖలు చేయండి',
    ...
    'about.desc': 'మా ఏఐ-ఆధారిత వ్యవస్థ ఎఫ్.ఐ.ఆర్ దాఖలును సరళంగా, వేగంగా మరియు అందుబాటులో ఉంచుతుంది',
    'gallery.1': 'ఏఐ-ఆధారిత సహాయం',
    ...
    'complaint.footer.powered': '💡 సర్వం ఏఐ 🇮🇳 ద్వారా ఆధారితం',
    'complaint.initial.msg': 'నమస్కారం! నేను మీ ఏఐ సహాయకుడిని. దయచేసి మీ ఫిర్యాదు గురించి నాకు తెలియజేయండి. మీరు ఇంగ్లీష్, హిందీ లేదా తెలుగులో మాట్లాడవచ్చు.',
  },
  hi: {
    'hero.title': 'एआई-संचालित एफ़आईआर दाखिल प्रणाली',
    'hero.quote': 'देर से मिला न्याय, न्याय नहीं है।\nएआई सहायता से अपनी शिकायत तुरंत दर्ज करें।',
    'hero.btn': 'अभी शिकायत दर्ज करें',
    'banner.heading': 'वास्तविक समय अपडेट',
    'banner.text': '🔔 24/7 एआई सहायता • तत्काल दाखिल • सुरक्षित और गोपनीय • बहुभाषी समर्थन • कानूनी सटीकता की गारंटी',
    'card.citizen.title': 'नागरिकों के लिए',
    'card.citizen.desc': 'अपनी भाषा में एआई आवाज सहायता के साथ अपनी एफ़आईआर जल्दी और आसानी से दर्ज करें।',
    'card.citizen.btn': 'एफ़आईआर दर्ज करें',
    ...
    'about.desc': 'हमारी एआई-संचालित प्रणाली एफ़आईआर दाखिल करना सरल, तेज़ और सुलभ बनाती है',
    'gallery.1': 'एआई-संचालित सहायता',
    ...
    'complaint.footer.powered': '💡 सर्वम एआई 🇮🇳 द्वारा संचालित',
    'complaint.initial.msg': 'नमस्ते! मैं आपका एआई सहायक हूँ। कृपया मुझे अपनी शिकायत के बारे में बताएं। आप अंग्रेजी, हिंदी या तेलुगु में बात कर सकते हैं।',
  }
};
